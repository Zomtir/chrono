...
impl NaiveDate {
    ...
    /// # Errors
    ///
    /// Returns [`Error::InvalidParameter`] on invalid hour, minute and/or second.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// assert_eq!(d.and_hms_opt(12, 34, 60), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_opt(12, 60, 56), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_opt(24, 34, 56), Err(Error::InvalidParameter));
    /// ```
    #[inline]
    ...
    /// assert_eq!(d.and_hms_milli_opt(12, 34, 59, 2_789), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_milli_opt(12, 34, 60,   789), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_milli_opt(12, 60, 56,   789), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_milli_opt(24, 34, 56,   789), Err(Error::InvalidParameter));
    /// ```
    #[inline]
    ...
    /// assert_eq!(d.and_hms_micro_opt(12, 34, 59, 2_789_012), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_micro_opt(12, 34, 60,   789_012), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_micro_opt(12, 60, 56,   789_012), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_micro_opt(24, 34, 56,   789_012), Err(Error::InvalidParameter));
    /// ```
    #[inline]
    ...
    /// assert_eq!(d.and_hms_nano_opt(12, 34, 59, 2_789_012_345), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_nano_opt(12, 34, 60,   789_012_345), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_nano_opt(12, 60, 56,   789_012_345), Err(Error::InvalidParameter));
    /// assert_eq!(d.and_hms_nano_opt(24, 34, 56,   789_012_345), Err(Error::InvalidParameter));
    /// ```
    #[inline]
