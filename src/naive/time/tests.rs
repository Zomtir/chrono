...
fn test_time_from_hms_milli() {
    ...
    assert_eq!(NaiveTime::from_hms_milli(3, 5, 59, 2_000), Err(INVALID));
    assert_eq!(NaiveTime::from_hms_milli(3, 5, 59, 5_000), Err(INVALID)); // overflow check
    assert_eq!(NaiveTime::from_hms_milli(3, 5, 59, u32::MAX), Err(INVALID));
}
...
fn test_time_from_hms_micro() {
    ...
    assert_eq!(NaiveTime::from_hms_micro(3, 5, 59, 2_000_000), Err(INVALID));
    assert_eq!(NaiveTime::from_hms_micro(3, 5, 59, 5_000_000), Err(INVALID)); // overflow check
    assert_eq!(NaiveTime::from_hms_micro(3, 5, 59, u32::MAX), Err(INVALID));
}
