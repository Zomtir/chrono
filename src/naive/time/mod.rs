...
impl NaiveTime {
    ...
    /// assert_eq!(from_hms(24, 0, 0), Err(Error::InvalidParameter));
    /// assert_eq!(from_hms(23, 60, 0), Err(Error::InvalidParameter));
    /// assert_eq!(from_hms(23, 59, 60), Err(Error::InvalidParameter));
    /// ```
    #[inline]
    ...
    /// assert_eq!(from_hms_milli(24, 0, 0, 0), Err(Error::InvalidParameter));
    ...
    /// assert_eq!(from_hms_micro(24, 0, 0, 0), Err(Error::InvalidParameter));
    ...
    /// assert_eq!(from_hms_nano(24, 0, 0, 0), Err(Error::InvalidParameter));
